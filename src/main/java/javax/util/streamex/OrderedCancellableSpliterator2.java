 ...
 * @author Tagir Valeev
 */
/* package */final class OrderedCancellableSpliterator2<T, A> implements Spliterator<A>, Cloneable {
    ...
    public Spliterator<A> trySplit() {
        ...
        try {
            synchronized (lock) {
                ...
                this.prefix = result;
                result.suffix = this;
                OrderedCancellableSpliterator2<T, A> prefixPrefix = result.prefix;
