...
public class StreamEx<T> extends AbstractStreamEx<T, StreamEx<T>> {
     ...
     *            associated with the same key, as supplied to
     *            {@link Map#merge(Object, Object, BiFunction)}
     * @return a {@code SortedMap} whose keys are the result of applying a key mapping
     *         function to the input elements, and whose values are the result
     *         of applying a value mapping function to all input elements equal
     *         to the key and combining them using the merge function
     *
    ...
    /**
     * Returns an infinite sequential unordered {@code StreamEx} where each element is
     * generated by the provided {@link Supplier}.  This is suitable for
    ...
    /**
     * Returns a sequential unordered {@code StreamEx} of given length which elements are
