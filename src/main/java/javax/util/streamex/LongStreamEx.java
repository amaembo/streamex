...
public class LongStreamEx implements LongStream {
	...
	public <V extends Comparable<? super V>> LongStreamEx sortedBy(
			LongFunction<V> keyExtractor) {
		return new LongStreamEx(stream.boxed()
	...
	public LongStreamEx sortedByDouble(LongToDoubleFunction keyExtractor) {
		return new LongStreamEx(
				...
				.sorted(Comparator.comparingDouble(i -> keyExtractor
						.applyAsDouble(i))).mapToLong(Long::longValue));
	}
