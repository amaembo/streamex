 ...
 * @author Tagir Valeev
 */
/* package */final @Deprecated class WithFirstSpliteratorOld<T, R> extends CloneableSpliterator<R, WithFirstSpliteratorOld<T, R>> implements Consumer<T> {
    ...
    private WithFirstSpliteratorOld<T, R> prefix;
    ...
    WithFirstSpliteratorOld(Spliterator<T> source, BiFunction<? super T, ? super T, ? extends R> mapper) {
        this.source = source;
        this.mapper = mapper;
    }
    ...
    public Spliterator<R> trySplit() {
        ...
        try {
            ...
            if (prefix == null)
                return null;
            WithFirstSpliteratorOld<T, R> result = doClone();
